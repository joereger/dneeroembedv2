package com.dneero.answerspanel
{
	...
	public class QTDropdown extends MovieClip implements QuestionType {
		...
		public function QTDropdown(questionXML:XML){
			//trace("QTDropdown instanciated");
		...
		function initListener (e:Event):void {
			//trace("QTDropdown.initListener() called");
		...
		public function resize (maxWidth:Number, maxHeight:Number):void {
			//trace("QTDropdown -- RESIZE -- maxWidth="+maxWidth+" maxHeight="+maxHeight);
			var currentHeight = 5;
